...
export default function Post({ slug }) {
  ...
  return (
    <div className="relative pb-16 bg-white overflow-hidden">
      <img className="w-full h-96 object-cover" src={data?.post.coverImage.url} />
...
// para o next saber quais o posts serão gerados de forma estática no momento de build
export const getStaticPaths = async () => {
  return {
    paths: [], // array pois não defini uma regra
    fallback: "blocking",
  };
};
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  return {
    props: {
      ...
      slug: params.slug, // prop que eu trago do server side
    },
  };
};
